...
export const EliminarOpinionModal = ({ onClose, opinionId, actualizarOpiniones }) => {
  ...
  const handleEliminarOpinion = () => {
    ...
    axios.delete(url, { headers })
      .then(response => {
        ...
        actualizarOpiniones(); // Actualiza el estado de las opiniones en el componente padre
        onClose();
      })
      .catch(error => {
        console.error('Error al eliminar la opinión:', error);
        setError('Error al eliminar la opinión. Por favor, inténtalo de nuevo.');
      });
  };
    return (
      <Transition.Root show={true} as={Fragment}>
        ...
        >
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              <div data-aos="fade-up" className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
