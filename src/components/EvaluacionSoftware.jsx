...
import ComponenteTabla from './Tabla';
  ...
  return (
    <>
      ...
      <div className="flex justify-around mt-10">
        <button onClick={volver} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out">Volver</button>
        <button onClick={finalizarEvaluacion} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out">Finalizar Evaluación</button>
      </div>
    </>
  );
};
