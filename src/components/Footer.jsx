            ...
            <div className="max-w-screen-xl px-4 pt-12 pb-6 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center mt-8 space-x-6">
                    ...
                    <a href="#" className="text-gray-400 hover:text-gray-500">
                        ...
                        <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                            <path fillRule="evenodd" d="M9.237 8.855v12.139h3.769v-6.003c0-1.584.298-3.118 2.262-3.118 1.937 0 1.961 1.811 1.961 3.218v5.904H21v-6.657c0-3.27-.704-5.783-4.526-5.783-1.835 0-3.065 1.007-3.568 1.96h-.051v-1.66H9.237zm-6.142 0H6.87v12.139H3.095z" clipRule="evenodd"></path>
                        </svg>
                    </a>
                </div>
