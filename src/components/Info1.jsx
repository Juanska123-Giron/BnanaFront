    ...
    <section className="px-4  pb-0" dir="rtl">
            <div className="container mx-auto">
                <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-30 sm:px-6 sm:py-16 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
                    ...
                    <div>
                        <h2 className="text-5xl font-bold tracking-tight text-gray-900 sm:text-5xl">Atrévete ahora! Red Bags</h2>
                        <p className="mt-4 text-gray-500">Para el verano, Bnana presenta su nueva campaña "Red Bags". Inspirados en la fuerza y la pasión del color rojo, nos hemos enfocado en transmitir esa energía y ese impulso hacia el amor y la elegancia mediante nuestras nuevas bolsas, las cuales están fabricadas al 100% con materiales reciclados.</p>
                    ...
                    <div className="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8 mt-0">
                        <img
                        src="./img/pro1-2.jpg"
