export const datosFuncionalidad = [
    {
        codigo: 1.1,
        item: 'Adecuación',
...
export const datosCapacidadDeMantenimiento = [
    {
        codigo: 5.1,
...
export const datosPortabilidad = [
    {
        codigo: 6.1,
        item: 'Adaptabilidad',
        descripcion: 'La capacidad del software para ser adaptado a diferentes entornos especificados sin aplicar acciones o medios diferentes de los previstos para el propósito del software considerado.',
        valor: '',
        observaciones: ''
      },
      {
...
export const datosCalidadDeUso = [
    {
        codigo: 7.1,
        item: 'Eficacia',
